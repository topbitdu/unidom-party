...
## v1.9.7
1. Improved the As Source Party concern for the argument validations of the #``relate!`` method, & the #``relate?`` method
...
## v1.9.8
1. Improved the Ruby Gem Specification to depend on [unidom-common](https://github.com/topbitdu/unidom-common) v1.10
2. Improved the Party Relation migration, the Person migration, the Shop migration, the Government Agency migration, the Company migration, the Collaborating migration for the #``opened_at`` column, & the #``closed_at`` column
