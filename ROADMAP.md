...
3. Improve the Shop model to include the Model Extension concern
...
2. Improve the As Source Party concern for the argument validations of the #is_related! method, & the #is_related? method
3. Improve the As Source Party shared examples for the argument validations of the #relate! method, & the #relate? method
4. Improve the As Source Party shared examples for the argument validations of the #is_related! method, & the #is_related? method
5. Improve the Company spec for the As Source Party concern
6. Improve the Government Agency spec for the As Source Party concern
7. Improve the Person spec for the As Source Party concern
8. Improve the Shop spec for the As Source Party concern
